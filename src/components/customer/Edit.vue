<template>
    <div>
        <h4 class="text-center mt-20">
            <small>
                <button class="btn btn-sucess" v-on:click="navigate()">View All Customers</button>
            </small>
        </h4>
        <div class="col-md-12 form-wrapper">
            ...
            <form id="create-post-form" @submit.prevent="editCustomer">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" id="last_name" v-model="customer.last_name" name="title" class="form-control" placeholder="Enter lastname">
                </div>
                <div class="form-group col-md-12">
